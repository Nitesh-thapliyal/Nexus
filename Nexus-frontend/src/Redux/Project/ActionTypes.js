...
export const FETCH_PROJECT_SUCCESS = "FETCH_PROJECT_REQUEST";
export const FETCH_PROJECT_FAILURE = "FETCH_PROJECT_REQUEST";

export const FETCH_PROJECT_BY_ID_REQUEST ="FETCH_PROJECT_BY_ID_REQUEST";
export const FETCH_PROJECT_BY_ID_SUCCESS = "FETCH_PROJECT_BY_ID_SUCCES";
